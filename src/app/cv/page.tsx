  ...
  return (
    <>
      ...
      <div className="bg-white text-gray-900 min-h-screen print:min-h-0 font-sans">
        <div className="max-w-[210mm] mx-auto px-4 sm:px-10 pb-10 pt-20 print:pt-1 print:pb-0 print:pl-0 print:pr-4">
          <div className="grid grid-cols-1 sm:grid-cols-[1fr_176px] print:grid-cols-[1fr_176px] gap-8">
            <header className="flex items-start gap-4 sm:block print:block sm:col-start-1 sm:row-start-1 print:col-start-1 print:row-start-1">
              ...
              <Image
                ...
                width={56}
                height={56}
                className="sm:hidden print:hidden rounded-full object-cover ring-2 ring-amber-300 ring-offset-2 shrink-0 w-14 h-14"
              />
            </header>

            <div className="hidden sm:flex print:flex justify-center items-start sm:col-start-2 sm:row-start-1 print:col-start-2 print:row-start-1">
              <Image
                src="/avatar.webp"
                alt="Maxime Miramond"
                width={84}
                height={84}
                className="rounded-full object-cover ring-2 ring-amber-300 ring-offset-2 w-21 h-21 print:ring-offset-0"
              />
            </div>
            ...
            <aside className="order-1 sm:order-0 print:order-0 sm:col-start-2 sm:row-start-2 print:col-start-2 print:row-start-2 space-y-5 border-t sm:border-t-0 print:border-t-0 border-amber-100 pt-6 sm:pt-0 print:pt-0 sm:border-l-2 print:border-l-2 sm:pl-6 print:pl-6">
              <section>
